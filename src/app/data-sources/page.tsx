...
export const metadata: Metadata = {
  ...
  description: 'How What Changed Around Me calculates neighborhood change intelligence using 100% open public records.',
};
    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 font-mono text-xs leading-relaxed">
        ...
        <div className="pt-6 border-t border-zinc-800 flex items-center justify-between">
          <Link href="/" className="btn-interactive px-4 py-2.5 bg-white text-black font-bold text-xs uppercase rounded-lg flex items-center gap-1.5">
